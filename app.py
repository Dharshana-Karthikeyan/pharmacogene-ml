...
with st.container(border=True):
    ...
    uploaded = st.file_uploader(
        "Select a CSV file (.csv) — download the example above if you don't have one",
        type=["csv"],
        label_visibility="collapsed",
        help="On mobile: download the example CSV first, then select it from your Downloads folder"
    )
